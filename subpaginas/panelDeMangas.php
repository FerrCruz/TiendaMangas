                              ...
                              <tr>
                                 <td width="20%" bgcolor="#002842">
                                    <p style="margin-left: 10px ">
                                       <font color="#FFFFF0">
                                          <span style="text-transform: uppercase"><span class="Estilo26"><?php echo $consulta['Nombre'] ?></span></span>
                                       </font>
                                 </td>
                                 <td width="20%" bgcolor="#002842">
                                    <p style="margin-left: 10px">
                                       <font color="#FFFFF0">
                                          <span style="text-transform: uppercase"><span class="Estilo26"><?php echo $consulta['Autor'] ?></span></span>
                                       </font>
                                 </td>
                                 <td width="20%" bgcolor="#002842">
                                    <p style="margin-left: 10px; text-align: center;">
                                       <font color="#FFFFF0">
                                        <span style="text-transform: uppercase"><span class="Estilo26"><?php echo $consulta['Tomo'] ?></span></span>
                                       </font>
                                 </td>
                                 <td width="20%" bgcolor="#002842">
                                    <p style="margin-left: 10px; text-align: center;">
                                    <font color="#FFFFF0">
                                       <span style="text-transform: uppercase"><span class="Estilo26"><?php echo $consulta['Precio'] ?></span></span>
                                    </font>
                                 </td>                                          
